...
Given closed curves $C_1,C_2$ agreeing with some orientation $q$ such that $int(C_2) \subset int(C_1)$, a glued curve is a closed curve  $(c_1,\ell_1,c_2,\ell_2)$ with orientation $q$ and $c_1 \subset C_1, c_2 \subset C_2$. The linels $\ell_1,\ell_2$ are called junction linels.
\end{definition}
