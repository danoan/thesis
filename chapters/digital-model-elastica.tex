...
We partition $\Omega$ in sets $X,F,B$ representing the optimization, foreground and background domains. Vectors $\mathbf{1}_X, \mathbf{1}_F, \mathbf{1}_B \in \mathbb{B}^m$ represent its respective active vectors.
