...
\includegraphics[scale=1.0]{figures/chapter3/convex-and-truncated/noisy-1.png}
}\hspace{1em}
\subfloat[$|x_p - x_q|$]{
\includegraphics[scale=1.0]{figures/chapter3/convex-and-truncated/absolute-difference-2.png}
}\hspace{1em}
\subfloat[$\min(3, |x_p-x_q|)$]{
\includegraphics[scale=1.0]{figures/chapter3/convex-and-truncated/truncated-3.png}
}
...
\includegraphics[scale=0.1]{figures/chapter3/master-posiform/posiform-graph-1.png}
}\\
\subfloat[$1$-Augmenting path $1$]{
\includegraphics[scale=0.1]{figures/chapter3/master-posiform/posiform-graph-2.png}
}%
\subfloat[$1$-Augmenting path $2$]{
\includegraphics[scale=0.1]{figures/chapter3/master-posiform/posiform-graph-3.png}
}\\%
\subfloat[$1$-Augmenting path $3$]{
\includegraphics[scale=0.1]{figures/chapter3/master-posiform/posiform-graph-4.png}
}%
\subfloat[$1$-Augmenting path $4$]{
\includegraphics[scale=0.1]{figures/chapter3/master-posiform/posiform-graph-5.png}
}\\%
...
\includegraphics[scale=0.1]{figures/chapter3/master-posiform/posiform-graph-6.png}
}%
...
\center
\subfloat{
\includegraphics[scale=0.25]{figures/chapter3/grabcut/coala/seeds.png}
}
\subfloat{
\includegraphics[scale=0.25]{figures/chapter3/grabcut/coala/gc-seg.png}
}\hspace{1em}
\subfloat{
\includegraphics[scale=0.25]{figures/chapter3/grabcut/vase/seeds.png}
}
\subfloat{
\includegraphics[scale=0.25]{figures/chapter3/grabcut/vase/gc-seg.png}
}
...
\includegraphics[scale=0.1]{figures/chapter3/move-making/move-making-1.png}
}%
\subfloat[Noisy image]{
\includegraphics[scale=0.1]{figures/chapter3/move-making/move-making-2.png}
}%
\subfloat[$\alpha$-expansion]{
\includegraphics[scale=0.1]{figures/chapter3/move-making/move-making-3.png}
}%
\subfloat[Range moves]{
\includegraphics[scale=0.1]{figures/chapter3/move-making/move-making-4.png}
}
...
\center
\subfloat[]{
\includegraphics[scale=0.15]{figures/chapter3/grabcut-connectivity/cp-1.png}
}
\subfloat[]{
