...
We categorize the experiments in two sections. In the first, we study the influence of the weight coefficient in the segmentation and in the second we discuss the choice of the disk radius.
...
\begin{tabular}{cccc}
& FlipFlow & BalanceFlow & GraphFlow\\
$r=3$ & \raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/flipseg/alpha-0.1/beta-1.0/gamma-2.0/radius-3/corrected-seg.png}} &
\raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/balanceseg/alpha-0.1/beta-1.0/gamma-2.0/radius-3/corrected-seg.png}} &
\raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/graphseg/alpha-0.1/beta-1.0/gamma-2.0/radius-3/corrected-seg.png}} \\[10em]

$r=25$ & \raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/flipseg/alpha-0.1/beta-1.0/gamma-2.0/radius-25/corrected-seg.png}} &
\raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/balanceseg/alpha-0.1/beta-1.0/gamma-2.0/radius-25/corrected-seg.png}} &
\raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/graphseg/alpha-0.1/beta-1.0/gamma-2.0/radius-25/corrected-seg.png}} \\[10em]

$r=50$ & \raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/flipseg/alpha-0.1/beta-1.0/gamma-2.0/radius-50/corrected-seg.png}} &
\raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/balanceseg/alpha-0.1/beta-1.0/gamma-2.0/radius-50/corrected-seg.png}} &
\raisebox{-.5\height}{\includegraphics[scale=0.4]{figures/chapter9/segmentation/exp-radius/graphseg/alpha-0.1/beta-1.0/gamma-2.0/radius-50/corrected-seg.png}}
\end{tabular}
\caption{Exp-$radius$}
