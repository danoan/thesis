...
\begin{itemize}
	...
	\item{\emph{Geometric priors} as length, area or curvature are useful due to its flexibility and theirs well stablished results.}
\end{itemize}}
%
%
\vspace{1em}
...
%
	\begin{itemize}
		...
		\onslide<3->{\item{$\lambda$-Maximal Segment Tangent ($\lambda$-MST)~\cite{lachaud07tangent}}}
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\onslide<1->{\item{$\lambda$-Maximal Digital Circular Arcs ($\lambda$-MDCA)~\cite{roussillon11mdca,schindele17}}
		\begin{itemize}
