...
\begin{center}
\begin{tabular}{ccc}
\highlight{1}{2,3}{\textbf{Segmentation}} & 
\highlight{2}{1,3}{\textbf{Restoration}} & 
\highlight{3}{1,2}{\textbf{Inpainting}}
\end{tabular}
\end{center}}
...
\textbf{Restoration:} $f_{\widehat{\vec{I}}} = \argmin_f E_{den}(f,f_{\vec{\widetilde{I}}}).$ & \raisebox{-.5\height}{\includegraphics[scale=0.24]{figures/motivation/image-analysis/denoising-stylised.png}}\\[2em]
...
\vspace{1em}
\onslide<7->{
In this work, we are interested in the combined use of \emph{perimeter} and \emph{squared curvature} as geometric priors.}
\end{frame}
