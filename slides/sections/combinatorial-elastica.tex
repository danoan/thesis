...
\begin{itemize}
\item{Neighbors are constructed by removing or adding a set of connected pixels.}
\end{itemize}	
	
\begin{minipage}[t][0.5\textheight]{1\textwidth}
\begin{center}
\begin{tabular}{cc}
\only<1>{\includegraphics[scale=0.25]{figures/combinatorial-elastica/main-inner.png}}
\only<2->{\includegraphics[scale=0.25]{figures/combinatorial-elastica/main-inner-block.png}}&
\only<1>{\includegraphics[scale=0.25]{figures/combinatorial-elastica/main-outer.png}}
\only<2->{\includegraphics[scale=0.25]{figures/combinatorial-elastica/main-outer-block.png}}
\end{tabular}
\end{center}	
\end{minipage}
...
\onslide<2>{
\begin{itemize}
\item{What is the influence of the choice of the estimation disk radius?}
\end{itemize}
}
